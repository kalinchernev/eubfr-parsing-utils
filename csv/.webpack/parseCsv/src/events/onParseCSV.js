...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/events/onParseCSV.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!*******************************************************************************************!*\
  !*** /home/kalin/Projects/eubfr-data-lake/node_modules/csv-parse/lib/ResizeableBuffer.js ***!
  \*******************************************************************************************/
...
/*!********************************************************************************!*\
  !*** /home/kalin/Projects/eubfr-data-lake/node_modules/csv-parse/lib/index.js ***!
  \********************************************************************************/
/*! no static exports found */
...
/***/ "../../../node_modules/stream-transform/lib/index.js":
/*!***************************************************************************************!*\
  !*** /home/kalin/Projects/eubfr-data-lake/node_modules/stream-transform/lib/index.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var csv_parse__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! csv-parse */ "../../../node_modules/csv-parse/lib/index.js");
/* harmony import */ var csv_parse__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(csv_parse__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var stream_transform__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! stream-transform */ "../../../node_modules/stream-transform/lib/index.js");
/* harmony import */ var stream_transform__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(stream_transform__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _lib_transform__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../lib/transform */ "./src/lib/transform.js");
...
const handler = () => {
  ...
  const readStream = fs__WEBPACK_IMPORTED_MODULE_0___default.a.createReadStream(path__WEBPACK_IMPORTED_MODULE_1___default.a.resolve(`../../${file}.csv`));
  const writeStream = fs__WEBPACK_IMPORTED_MODULE_0___default.a.createWriteStream(path__WEBPACK_IMPORTED_MODULE_1___default.a.resolve(`../../${file}.ndjson`)); // Try with both to see the difference.
  // const parser = parse({ columns: true, skip_lines_with_error: true });

  const parser = csv_parse__WEBPACK_IMPORTED_MODULE_2___default()({
    columns: true,
    to: 11
  }); // Transform

  const transformer = stream_transform__WEBPACK_IMPORTED_MODULE_3___default()((record, cb) => {
    try {
      const data = Object(_lib_transform__WEBPACK_IMPORTED_MODULE_4__["default"])(record);
...
/******/ });
//# sourceMappingURL=onParseCSV.js.map